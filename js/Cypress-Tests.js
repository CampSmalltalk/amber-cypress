...
return self;},
args: [],
source: unescape('testSnapshot%0A%09%7C%20name%20pkg%20packageDefinitions%20expectedDefinitions%20%7C%0A%09name%20%3A%3D%20%27Cypress-Mocks%27.%0A%09pkg%20%3A%3D%20CypressPackage%20new%20name%3A%20name.%0A%09packageDefinitions%20%3A%3D%20pkg%20snapshot%20definitions.%0A%09expectedDefinitions%20%3A%3D%20self%20baseDefinitions.%0A%09self%20assert%3A%20%28expectedDefinitions%20size%20%3D%20packageDefinitions%20size%29.%0A%09packageDefinitions%20do%3A%20%5B%3Adef%20%7C%0A%09%09%28expectedDefinitions%20includes%3A%20def%29%0A%09%09%09ifFalse%3A%20%5B%20%0A%09%09%09%09def%20inspect.%0A%09%09%09%09self%20assert%3A%20false%20%5D%5D.'),
messageSends: ["name:", "new", "definitions", "snapshot", "baseDefinitions", "assert:", unescape("%3D"), "size", "do:", "ifFalse:", "includes:", "inspect"],
referencedClasses: ["CypressPackage"]
}),
smalltalk.CypressDefinitionTest);
...
return self;},
args: [],
source: unescape('baseDefinitions%0A%09%7C%20className%20classClassName%20%7C%0A%09className%20%3A%3D%20%27CypressMockBasic%27.%0A%09classClassName%20%3A%3D%20%27CypressMockBasic%20class%27.%0A%09%5E%7B%0A%09%09%28CypressClassDefinition%0A%20%20%20%20%20%20%20%20%09%09name%3A%20className%0A%20%20%20%20%20%20%20%09%09%20%09superclassName%3A%20%27Object%27%0A%20%20%20%20%20%20%20%09%09%09category%3A%20%27Cypress-Mocks%27%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09instVarNames%3A%20%23%28%27name%27%29%0A%09%09%09classInstVarNames%3A%20%23%28%27current%27%29%0A%20%20%20%20%20%20%20%20%09%09comment%3A%20%27This%20mock%20contains%20basic%20class%20and%20instance%20method%20selectors%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20classClassName%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20true%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27initialize%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27initialization%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27initialize%0A%09self%20current%3A%20self%20new%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20classClassName%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20true%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27current%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27current%0A%09%5Ecurrent%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20classClassName%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20true%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27current%3A%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27current%3A%20anObject%0A%09current%20%3A%3D%20anObject%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20className%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20false%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27initialize%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27initialization%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27initialize%0A%09super%20initialize.%0A%09self%20name%3A%20%27%27Unknown%27%27%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20className%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20false%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27name%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27name%0A%09%5Ename%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20className%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20false%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27name%3A%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27name%3A%20aString%0A%09name%20%3A%3D%20aString%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20className%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20false%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27extra%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27extra%0A%09%22extra%20method%22%27%29%0A%09%7D'),
...
return self;},
args: [],
source: unescape('targetDefinitions%0A%09%7C%20className%20classClassName%20%7C%0A%09className%20%3A%3D%20%27CypressMockBasic%27.%0A%09classClassName%20%3A%3D%20%27CypressMockBasic%20class%27.%0A%09%5E%7B%0A%09%09%28CypressClassDefinition%0A%20%20%20%20%20%20%20%20%09%09name%3A%20className%0A%20%20%20%20%20%20%20%09%09%20%09superclassName%3A%20%27Object%27%0A%20%20%20%20%20%20%20%09%09%09category%3A%20%27Cypress-Mocks%27%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09instVarNames%3A%20%23%28%27name%27%29%0A%09%09%09classInstVarNames%3A%20%23%28%27current%27%29%0A%20%20%20%20%20%20%20%20%09%09comment%3A%20%27This%20mock%20contains%20basic%20class%20and%20instance%20method%20selectors%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20classClassName%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20true%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27initialize%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27initialization%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27initialize%0A%09self%20current%3A%20self%20new%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20classClassName%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20true%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27current%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27current%0A%09%5Ecurrent%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20classClassName%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20true%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27current%3A%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27current%3A%20anObject%0A%09current%20%3A%3D%20anObject%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20className%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20false%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27initialize%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27initialization%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27initialize%0A%09super%20initialize.%0A%09self%20name%3A%20%27%27Unknown%27%27%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20className%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20false%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27name%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27name%0A%09%5Ename%27%29.%0A%20%20%20%09%20%09%28CypressMethodDefinition%0A%20%20%20%20%20%20%20%20%20%20%09%09className%3A%20className%0A%20%20%20%20%20%20%20%20%09%09classIsMeta%3A%20false%0A%20%20%20%20%20%20%20%20%09%09selector%3A%20%27name%3A%27%0A%20%20%20%20%20%20%20%20%09%09category%3A%20%27accessing%27%0A%20%20%20%20%20%20%20%20%09%09source%3A%27name%3A%20aString%0A%09%22changed%20method%22%0A%09name%20%3A%3D%20aString%27%29%0A%09%7D'),
messageSends: ["name:superclassName:category:instVarNames:classInstVarNames:comment:", "className:classIsMeta:selector:category:source:"],
referencedClasses: ["CypressClassDefinition", "CypressMethodDefinition"]
}),
smalltalk.CypressDefinitionTest);
